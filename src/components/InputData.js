...
import {addToCurrentData, addCurrentDataToSessions, resetCurrentData} from '../redux/input-data/actions';
...
const InputData = ({
    ...
    useEffect(() => {
        if (!!videoRef) {
            navigator.mediaDevices.getUserMedia({ video: { facingMode: "environment", height: 200, width: 200 }})
